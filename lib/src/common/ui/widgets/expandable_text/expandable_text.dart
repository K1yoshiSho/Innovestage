...
import 'package:innovestage/src/common/ui/widgets/expandable_text/text_parser.dart';
...
class ExpandableTextState extends State<ExpandableText>
  ...
  void dispose() {
    ...
    for (final recognizer in _textSegmentsTapGestureRecognizers) {
      recognizer.dispose();
    }
    super.dispose();
  }
  ...
  void _updateText() {
    ...
    for (final element in _textSegments) {
